...
const content = [
  {
    company: "Cygni",
    desc: "Konsultbolag med stark utvecklarkultur. Uppdrag i modern JS/TS (React/Node) och mycket fokus på kompetensutveckling",
    city: "🏢 Östersund",
  },
  {
    company: "Sogeti",
    desc: "Stort konsultnät med trainee/Careerbooster. Bra för att bygga bredd i fullstack JS/Node + moln hos lokala kunder",
    city: "🏢 Östersund/Sundsvall",
  },
  {
    company: "CGI",
    desc: "Globalt IT-bolag med samhällsnyttiga projekt. Agila team och frontend i JavaScript",
    city: "🏢 Östersund/Sundsvall",
  },
  {
    company: "Startups",
    desc: "Snabba produktteam där man med stort ansvar kan bygga end-to-end i JS/TS",
    city: "🏢 Överallt",
  },
];
getWeatherData();
